...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get page list for project' }),
    (0, swagger_1.ApiQuery)({ name: 'projectId', description: 'Project ID to get pages for' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get page details by ID' }),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Update page information' }),
    __param(0, (0, common_1.Param)('id')),
...
exports.PageController = PageController = __decorate([
    (0, swagger_1.ApiTags)('Page Management Module'),
